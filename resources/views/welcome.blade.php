                                            ...
                                            <div class="row justify-content-center g-4 align-items-center"
                                                ...
                                                <div class="col-lg-3 col-md-12" data-cue="slideInUp"
                                                    ...
                                                    <!-- <div class="online-training-banner-left-image"><img
                                                            src="landing/images/course99.png"
                                                            alt="image"></div> -->
                                                </div>
                                                <div class="col-xl-6 col-md-12" data-cue="slideInUp"
                                                    ...
                                                    <div
                                                        ...
                                                        <p>Solving Today’s Problems with Tomorrow’s Technology.</p>
                                                        <ul class="banner-btn">
                                                            <li><a href="{{route('tenant_create')}}"
                                                                    class="default-btn">Get Started<svg
...
animation-name: slideInUp; animation-duration: 1000ms; animation-timing-function: ease; animation-delay: 0ms; animation-direction: normal; animation-fill-mode: both;">Meet
                                            ...
                                            <div class="row justify-content-center g-4" data-cues="slideInUp"
                                                ...
                                                <div class="col-lg-3 col-sm-6" data-cue="slideInUp" data-duration="1000"
                                                    ...
                                                    <div class="ot-team-card  wrap-style">
                                                        ...
                                                        <div class="content">
                                                            <h3><a
                                                                    href="#">Ada Blessing .U</a></h3><span>Chief Marketing Officer/Data & Intelligence Lead</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-sm-6" data-cue="slideInUp" data-duration="1000"
    ...
    margin-top: 70px;">
                ...
                <div class="modal fade" id="pdfModall" tabindex="-1">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">PDF Viewer</h5>
