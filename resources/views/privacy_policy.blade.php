            ...
            <div class=" drag-container">
                ...
                <div class="olan-fullwidth-top" aria-label="Blocks">
                    <aside id="block-region-fullwidth-top" class="block-region" data-blockregion="fullwidth-top"
                        ...
                        <section id="inst198" class=" block_html block  card mb-3" role="region" data-block="html"
                            data-instance-id="198" aria-label="Text">
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="card-text content mt-3">
                                    <div class="no-overflow">
                                        <div class="privacy-policy-area ptb-140">
                                            <div class="container">
                                                <div class="privacy-policy-content">
                                                    <p><i>This Privacy Policy was last updated on September 1, 2025.</i>
                                                    </p>
                                                    <h3>1. What Data We Get</h3>
                                                    <blockquote class="blockquote">
                                                        <p>We collect certain data from you directly, like information
                                                            you enter yourself, data about your participation in
                                                            courses, and data from third-party platforms you connect
                                                            with Olan. We also collect some data automatically, like
                                                            information about your device and what parts of our Services
                                                            you interact with or spend time using.</p>
                                                    </blockquote>
                                                    <h3>2. Data You Provide to Us</h3>
                                                    <p>We may collect different data from or about you depending on how
                                                        you use the Services. Below are some examples to help you better
                                                        understand the data we collect.</p>
                                                    <h3>3. How We Get Data About You</h3>
                                                    <p>We use tools like cookies, web beacons, analytics services, and
                                                    ...
                                                    <p>You can choose not to provide certain data to us, but you may not
                                                        be able to use certain features of the Services.</p>
                                                    <ul>
                                                        ...
                                                        <li>The browser or device you use may allow you to control
                                                            ...
                                                            LSOs through their Website Storage Settings panel.</li>
                                                        <li>To get information and control cookies used for tailored
                                                            ...
                                                            their Cookie Policy.</li>
                                                        <li>To update data you provide directly, log into your account
                                                            and update your account at any time.</li>
                                                    </ul>
                                                    <h3>6. Our Policy Concerning Children</h3>
                                                    <p>We recognize the privacy interests of children and encourage
                        ...
                        </section><a href="#sb-2" class="visually-hidden-focusable">Skip [Olan] CTA</a>

                        <section id="inst199" class=" block_olan_cta block  card mb-3" role="region"
                            data-block="olan_cta" data-instance-id="199" aria-labelledby="instance-199-header">

                            <div class="card-body p-3">

                                <h3 id="instance-199-header" class="h5 card-title d-inline">[Olan] CTA</h3>
                                ...
                                <div class="card-text content mt-3">
                                    <div class="cta-wrap-area ptb-140">
                                            ...
                                            <div class="cta-wrap-content section-title-animation animation-style1"
                                                ...
                                                <h2 class="title-animation">
                                                    Start Your Journey Toward In-Demand <span>
                                                        Skills Today <img
                                                            src="https://olan-moodle.hibootstrap.com/pluginfile.php/271/block_olan_cta/images/1/title-line.png"
                                                            alt="image"> </span>
                                                </h2>
                                        ...
                                        <div class="cta-wrap-shape1" data-speed="0.02" data-revert="true">
                                            <img src="https://olan-moodle.hibootstrap.com/pluginfile.php/271/block_olan_cta/images/2/cta-shape5.png"
                                                alt="image">
                                        </div>
                                        <div class="cta-wrap-shape2" data-speed="0.02" data-revert="true">
                                            <img src="https://olan-moodle.hibootstrap.com/pluginfile.php/271/block_olan_cta/images/3/cta-shape6.png"
                                                alt="image">
                                        </div>
                                    </div>
                                                                ...
                                                                <div class="page-context-header">
                                                                    ...
                                                                    <div class="page-header-headings">
                                                                        <div
                                                                            ...
                                                                            Page</div>
                                                                        <h3 id='' class='h2'>Privacy Policy</h3>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="d-none" id="page-navbar">
                                                                <nav aria-label="Navigation bar">
                                                                    <ol class="breadcrumb">
                                                                        ...
                                                                        <li class="breadcrumb-item">
                                                                            <a href="https://olan-moodle.hibootstrap.com/mod/page/view.php?id=38"
                                                                                aria-current="page" title="Page">
                                                                                Privacy Policy
                                                                            </a>
                                                                        </li>
                                                ...
                                                <div class="olan-main">
                                                    ...
                                                    <div class="activity-header" data-for="page-activity-header">
                                                        ...
                                                        <div data-region="activity-information"
                                                            data-activityname="Privacy Policy"
                                                    ...
                                                    <div class="modified">Last modified: Sunday, 7 September 2025, 5:28
                                                        PM</div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="float-start">
                                                                    <a href="https://olan-moodle.hibootstrap.com/mod/page/view.php?id=37&forceview=1"
                                                                        id="prev-activity-link"
                                                                        class="btn btn-link">&#x25C4; Purchase Guide</a>
                                                                ...
                                                                <div class="mdl-align">
                                                                    <div class="urlselect">
                                                                        <form method="post"
                                                                            ...
                                                                            id="url_select_f698b3ec04ab2814">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="float-end">
                                                                    <a href="https://olan-moodle.hibootstrap.com/mod/page/view.php?id=39&forceview=1"
                                                                        ...
                                                                        class="btn btn-link">Terms &amp; Conditions
                                                                        &#x25BA;</a>
