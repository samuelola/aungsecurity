          ...
          <div class="login-card login-dark login-bg">
            <div>
              ...
              <div class="login-main"> 
                ...
                <form class="theme-form" action="{{route('verify_email',$tenant->subdomain)}}" method="post" id="otpForm">
                  @csrf
                  ...
                  <div class="form-group">
                    ...
                    <div class="text-end mt-3">
                        <button id="verifyBtn" class="btn btn-primary btn-block w-100" type="submit">Verify</button>
                    </div>
                  </div>
                 
                  
                  <p class="mt-4 mb-0 text-center"><span style="color:#292929">Don't have account?<span><a style="font-weight:600;" class="ms-2" href="{{route('tenant_new_user_reg',$tenant->subdomain)}}">Create Account</a></p>
                </form>
...
resendBtn.addEventListener("click", function() {
    ...
    fetch("{{ route('resend_verification',$tenant->subdomain) }}", {
        method: "POST",
        headers: {
