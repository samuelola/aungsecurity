  <footer class="footer-area wrap-style2">
                                ...
                                <div class="col-lg-3 col-sm-6 col-lg-3 col-sm-6" data-cue="slideInUp"
                                    ...
                                    <div class="single-footer-widget">
                                        ...
                                        <ul class="info-list">
                                            <li>
                                                <span>Email:</span>
                                                <a href="mailto:support@olan.com">info@aungsolutions.com</a>
                                            </li>
                                            <li>
                                                <span>Phone:</span>
                                                <a href="tel:18001234567">+2347062140380</a>
                                            </li>
                                            <li>
                                                <span>Address:</span>
                                                Teju Royal Estate, Block A1, House 4C Ojo, Lagos, Nigeria
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <script src="{{asset('landing/js/require.min.js')}}"></script>
                <script src="{{asset('landing/js/poly.js')}}"></script>
                <script src="{{asset('landing/js/moodlesimple-min.js')}}"></script>
                <script type="text/javascript" charset="utf-8" src="{{asset('landing/js/first.js')}}"></script>
                <script type="text/javascript" charset="utf-8" src="{{asset('landing/js/private.js')}}"></script>
                <script src="{{asset('landing/js/javascript-static.js')}}"></script>
