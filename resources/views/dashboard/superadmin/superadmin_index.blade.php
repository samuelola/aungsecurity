                    ...
                    <table class="table">
                      <thead>
                        <tr class="border-bottom-secondary border-top-0">
                            ...
                            <th scope="col">Platform Earning</th>
                            <th scope="col">Estate Earning</th>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                          ...
                          @foreach($allactivities as $value)
                            ...
                            <tr class="{{$colorClass}}">
                              <th scope="row">{{$sn++}}</th>
                              <td>{{$value->properties['estate_name'] ?? 'N/A'}} </td>
                              <td>{{$value->description ?? 'N/A'}} </td>
                              <td>{{$value->causer?->first_name ?? 'System'}}  {{$value->causer?->last_name ?? 'System'}} </td>
                              <td>{{$value->properties['role'] ?? '-' }}</td>
                              <td>{{$value->properties['ip'] ?? '-' }}</td>
                              <td>{{$value->created_at->format('d M Y h:i A') ?? 'N/A' }}</td>
