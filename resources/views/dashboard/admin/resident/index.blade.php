                           ...
                           <div class="container-fluid table-space basic_table">
                            <div class="row">
                                <div class="card-no-border d-flex justify-content-between align-items-center">
                                    ...
                                    {{-- <a href="{{ route('residents.print', $tenant->subdomain) }}"
                                    class="btn btn-primary">
                                        Print <i class="ti-printer"></i>
                                    </a> --}}
                                    ...
                                    <div class="table-responsive signal-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td scope="row">
                                                     @if($allresident?->kyc?->kyc_completed == true)
                                                ...
                                                <td>
                                                    <button 
                                                        ...
                                                        data-status="{{ $allresident?->kyc?->kyc_completed ?? 'N/A' }}"
