                                 ...
                                 <div class="col-sm-12">
                                    ...
                                    <div class="table-responsive signal-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">{{$sn++}}</th>
                                                <td scope="row">{{ucfirst($accesslog->Invitation?->resident?->first_name ?? 'N/A')}}  {{ucfirst($accesslog->Invitation?->resident?->last_name ?? '')}} </td>
                                                <td scope="row">{{$accesslog->Invitation->visitor->first_name ?? 'N/A'}} {{$accesslog->Invitation->visitor->last_name ?? 'N/A'}}</td>
                                                <td scope="row">
                                                     @if($accesslog->status == 'pending')
                                                        <span class="badge badge-light-warning">
                                                            Pending
                                                        </span>
                                                     @elseif($accesslog->status == 'used') 
                                                        <span class="badge badge-light-success">
                                                            Used
                                                        </span>
                                                     @elseif($accesslog->status == 'exited') 
                                                         <span class="badge badge-light-warning">
                                                            Exited
                                                        </span>
                                                     @elseif($accesslog->status == 'expired') 
                                                ...
                                                <td scope="row">{{$accesslog->gate_name ?? 'N/A'}} </td>
                                                <td scope="row">{{$accesslog->action ?? 'N/A'}} </td>
                                                <td scope="row">{{$accesslog->Invitation->visit_date ?? 'N/A'}} </td>
                                                <td scope="row">{{$accesslog->Invitation->valid_from ?? 'N/A'}} </td>
                                                <td scope="row">{{$accesslog->Invitation->valid_to ?? 'N/A'}} </td>
