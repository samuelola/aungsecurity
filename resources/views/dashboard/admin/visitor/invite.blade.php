                                    ...
                                    <div class="table-responsive signal-table">
                                        ...
                                        <tbody>
                                            @php
                                                $sn = 1;
                                            @endphp
                                            @foreach($invitelogs as $invitation)
                                            <tr>
                                                <th scope="row">{{$sn++}}</th>
                                                 <td scope="row">
                                                ...
                                                <td>
                                                    @if($invitation->visitor)
                                                     {{$invitation->visitor->first_name ?? $invitation->invitedResident->first_name ?? ''}}
                                                ...
                                                <td scope="row">{{\Carbon\Carbon::parse($invitation->valid_from)->format('g:i A')}} </td>
                                                <td scope="row">{{\Carbon\Carbon::parse($invitation->valid_to)->format('g:i A')}} </td>
