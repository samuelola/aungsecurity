                ...
                <div class="custom-menu overflow-hidden">
                  <ul class="profile-body">
                    <li class="d-flex"> 
                      ...
                      </svg><a class="ms-2" href="{{$kyc && $kyc->kyc_completed ? route('admin.details',$tenant->subdomain) : '#'}}">Account</a>
                    </li>

                    <li class="d-flex"> 
                      <svg class="svg-color">
                        <use href="https://admin.pixelstrap.net/admiro/assets/svg/iconly-sprite.svg#Profile"></use>
                      </svg><a class="ms-2" href="{{$kyc && $kyc->kyc_completed ? route('admin.card.show',$tenant->subdomain) : '#'}}">ID Card</a>
                    </li>
                    ...
                    <li class="d-flex"> 
                      ...
                      @php 
                          ...
                          $get_subdomain = $tenant->subdomain;
                      @endphp
                      <form id="logout-form" method="POST" action="{{ route('admin_tenant.logout',$get_subdomain) }}">
                              @csrf
