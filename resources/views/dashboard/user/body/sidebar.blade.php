            ...
            <ul class="sidebar-menu" id="simple-bar">
              ...
              <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link" href="javascript:void(0)">
                ...
                <ul class="sidebar-submenu">
                  <li> <a href="{{route('allwallet',$tenant->subdomain)}}">Wallet</a></li>
                  <li><a href="{{route('fundwallet',$tenant->subdomain)}}">Fund Wallet</a></li>
                  <li><a href="{{route('resident_transaction',$tenant->subdomain)}}">Transaction</a></li>
                </ul>
